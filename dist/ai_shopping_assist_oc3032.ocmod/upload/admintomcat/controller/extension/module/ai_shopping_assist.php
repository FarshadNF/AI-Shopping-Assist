...
class ControllerExtensionModuleAiShoppingAssist extends Controller {
	...
	public function index(): void {
		$this->load->language('extension/module/ai_shopping_assist');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/module/ai_shopping_assist', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/module/ai_shopping_assist/save', 'user_token=' . $this->session->data['user_token']);
		$data['clear_logs'] = $this->url->link('extension/module/ai_shopping_assist/clearLogs', 'user_token=' . $this->session->data['user_token']);
		$data['export_logs'] = $this->url->link('extension/module/ai_shopping_assist/exportLogs', 'user_token=' . $this->session->data['user_token']);
		$data['import_knowledge'] = $this->url->link('extension/module/ai_shopping_assist/importKnowledge', 'user_token=' . $this->session->data['user_token']);
		$data['clear_knowledge'] = $this->url->link('extension/module/ai_shopping_assist/clearKnowledge', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/module/ai_shopping_assist', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/module/ai_shopping_assist')) {
	...
	public function exportLogs(): void {
		...
		if (!$this->user->hasPermission('access', 'extension/module/ai_shopping_assist')) {
	...
	public function install(): void {
		...
		$this->model_setting_event->addEvent(
			...
			'extension/module/ai_shopping_assist/inject',
			1,
			10
		);
	...
	private function importBundledKnowledge(): void {
		$candidates = [
			dirname(__DIR__, 4) . '/install_data/enriched_cache.json'
		];

		if (defined('DIR_APPLICATION')) {
			$candidates[] = dirname(rtrim(DIR_APPLICATION, '/\\')) . '/install_data/enriched_cache.json';
		}
