...
$_['text_leads'] = 'لیدهای بات';
$_['text_no_leads'] = 'هنوز لیدی ثبت نشده.';
...
$_['help_agent_prompts'] = 'پرامپت Manu همیشه فعال است. براساس پیام مشتری، پرامپت مرتبط‌ترین ساب‌ایجنت خودکار انتخاب می‌شود؛ در درخواست‌های فنی، Volt می‌تواند همراه Vera یا Sol فعال شود.';
...
$_['help_catalog_token'] = 'Optional. If set, catalog JSON requests must include X-Manu-Token or X-AI-Assistant-Token.';
$_['help_suggestion_controls'] = 'مشخص کنید Manu بعد از هر پاسخ کدام نوع پیشنهادها را تولید و نمایش دهد. موارد غیرفعال از تاریخچه چت نیز نمایش داده نمی‌شوند.';
$_['help_redirect_utm'] = 'اختیاری. پارامترهای UTM برای ریدایرکت‌های Manu، مثلاً: utm_source=manu&utm_medium=assistant&utm_campaign=chat';
...
$_['column_product_name'] = 'محصول';
$_['column_request_id'] = 'شناسه RFQ';
$_['column_item'] = 'ردیف';
$_['column_product_identity'] = 'برند / مدل / پارت‌نامبر';
$_['column_brand'] = 'برند / سازنده';
$_['column_model'] = 'مدل';
$_['column_part_number'] = 'پارت‌نامبر';
$_['column_qty'] = 'تعداد';
$_['column_unit'] = 'واحد';
$_['column_item_details'] = 'جزئیات محصول';
$_['column_requirements'] = 'الزامات';
$_['column_source_request'] = 'متن اصلی درخواست';
$_['column_name'] = 'نام';
$_['column_company'] = 'شرکت';
$_['column_contact_number'] = 'شماره تماس';
$_['column_contact'] = 'راه تماس';
$_['column_email'] = 'ایمیل';
$_['column_delivery_location'] = 'محل تحویل';
$_['column_page_url'] = 'آدرس صفحه';
$_['column_page_title'] = 'عنوان صفحه';
...
$_['error_lead_storage'] = 'ساخت جدول لیدها (%s) انجام نشد. خطای دیتابیس را در لاگ OpenCart بررسی کنید.';
